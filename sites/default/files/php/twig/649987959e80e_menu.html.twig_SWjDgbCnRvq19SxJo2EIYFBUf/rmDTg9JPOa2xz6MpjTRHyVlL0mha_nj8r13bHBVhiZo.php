...
class __TwigTemplate_e11318f213e9d41f7014f6ed8d42f1fecbfdbcdd78cd921c60aeb18e319ba237 extends \Twig\Template
{
    private $source;
    private $macros = [];
        ...
        try {
            ...
            if (($context["items"] ?? null)) {
                ...
                if ((($context["menu_level"] ?? null) == 0)) {
                    // line 33
                    echo "      <ul";
                    echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [0 => "nav-menu"], "method", false, false, true, 33), 33, $this->source), "html", null, true);
                    echo ">
    ";
                } else {
                    // line 35
...
{% macro menu_links(items, attributes, menu_level) %}
  ...
  {% endif %}
{% endmacro %}
", "core/themes/bartik/templates/classy/navigation/menu.html.twig", "E:\\xampp\\htdocs\\drupal\\core\\themes\\bartik\\templates\\classy\\navigation\\menu.html.twig");
    }
